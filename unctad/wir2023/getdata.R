...
ori <- list( # 原始数据的信息 =========================================== {{{1
    ...
    last_udpate_date = "2023-09-19",
    lib = "https://unctad.org/system/files/non-official-document/",
    cache = file.path(Sys.getenv("HOME"), ".cache", "R", "wir2023"),
    unitrow = 2L,
    mainkey = c(name = "region_economy", code = "code", no = "no"),
    time = "year",
    flow = list(        # 流量 ------------------------------------------ {{{2
        inward  = list(file = "WIR2023_tab01.xlsx",
                       desc = "Annex table 01: FDI inflows, by region and economy, 1990-2022"),
        outward = list(file = "WIR2023_tab02.xlsx",
                       desc = "Annex table 02: FDI outflows, by region and economy, 1990-2022")
    ),
    stock = list(       # 存量 ------------------------------------------ {{{2
        inward  = list(file = "WIR2023_tab03.xlsx",
                       desc = "Annex table 03: FDI inward stock, by region and economy, 1990-2022"),
        outward = list(file = "WIR2023_tab04.xlsx",
                       desc = "Annex table 04: FDI outward stock, by region and economy, 1990-2022")
    ),
    ma = list(          # 并购 ------------------------------------------ {{{2
        value = list(       # 按金额 ------------------------------------ {{{3
            sale = list(
                byregion = list(file = "WIR2023_tab05.xlsx",
                                desc = "Annex table 05: Value of net cross-border M&A sales, by region/economy of seller, 1990-2022"),
                bysector = list(file = "WIR2023_tab09.xlsx",
                                desc = "Annex table 09: Value of net cross-border M&A sales, by sector/industry, 1990-2022")
            ),
            purchase = list(
                byregion = list(file = "WIR2023_tab06.xlsx",
                                desc = "Annex table 06: Value of net cross-border M&A purchases, by region/economy of purchaser, 1990-2022"),
                bysector = list(file = "WIR2023_tab10.xlsx",
                                desc = "Annex table 10: Value of net cross-border M&A purchases, by sector/industry, 1990-2022")
            )
        ),
        number = list(      # 按数量 ----------------------------------------- {{{3
            sale = list(
                byregion = list(file = "WIR2023_tab07.xlsx",
                                desc = "Annex table 07: Number of net cross-border M&A sales, by region/economy of seller, 1990-2022"),
                bysector = list(file = "WIR2023_tab11.xlsx",
                                desc = "Annex table 11: Number of net cross-border M&A sales, by sector/industry, 1990-2022")
            ),
            purchase = list(
                byregion = list(file = "WIR2023_tab08.xlsx",
                                desc = "Annex table 08: Number of net cross-border M&A purchases, by region/economy of purchaser, 1990-2022"),
                bysector = list(file = "WIR2023_tab12.xlsx",
                                desc = "Annex table 12: Number of net cross-border M&A purchases, by sector/industry, 1990-2022")
            )
        )
    ),
    greenfield = list(  # 绿地投资 -------------------------------------- {{{2
        value = list( # 按项目金额 -------------------------------------- {{{3
            bysource      = list(file = "WIR2023_tab13.xlsx",
                                 desc = "Annex table 13: Value of announced greenfield FDI projects, by source, 2003-2022"),
            bydestination = list(file = "WIR2023_tab14.xlsx",
                                 desc = "Annex table 14: Value of announced greenfield FDI projects, by destination, 2003-2022"),
            bysector      = list(file = "WIR2023_tab15.xlsx",
                                 desc = "Annex table 15: Value of announced greenfield FDI projects, by sector/industry, 2003-2022")
        ),
        number = list( # 按项目数 --------------------------------------- {{{3
            bysource      = list(file = "WIR2023_tab16.xlsx",
                                 desc = "Annex table 16: Number of announced greenfield FDI projects, by source, 2003-2022"),
            bydestination = list(file = "WIR2023_tab17.xlsx",
                                 desc = "Annex table 17: Number of announced greenfield FDI projects, by destination, 2003-2022"),
            bysector      = list(file = "WIR2023_tab18.xlsx",
                                 desc = "Annex table 18: Number of announced greenfield FDI projects, by sector/industry, 2003-2022")
        )
    ),
    topmne = list(      # 最大的跨国公司 -------------------------------- {{{2
        all        = list(file = "WIR2023_tab19.xlsx",
                          desc = "Annex table 19: The world's top 100 non-financial MNEs, ranked by foreign assets, 2022"),
        developing = list(file = "WIR2023_tab20.xlsx",
                          desc = "Annex table 20: The top 100 non-financial MNEs from developing and transition economies, ranked by foreign assets, 2021")
    )
)
